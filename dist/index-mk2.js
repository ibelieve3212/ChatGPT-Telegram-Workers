...
const BUILD_TIMESTAMP = 1788947662;
const BUILD_VERSION = "e3ec402";
...
const TELEGRAM_API_TIMEOUT_MS = 15e3;
class APIClientBase {
  token;
...
class StopMessageHandling extends Error {
  constructor(message) {
    super(message);
    this.name = "StopMessageHandling";
  }
}
